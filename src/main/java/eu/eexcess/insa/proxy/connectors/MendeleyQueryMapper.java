 ...
 */
	public void process(Exchange exchange) throws Exception {
	    ...
	    in.setHeader("QueryEndpoint",("http4://api.mendeley.com/oapi/documents/search/"+URLEncoder.encode(query.toString(), "UTF8")+"?consumer_key="+consummerKey+"&items="+itemsPerPage));
	}
